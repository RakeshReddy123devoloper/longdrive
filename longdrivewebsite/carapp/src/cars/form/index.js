...
//     const isNumberOfDaysValid = formData.numberOfDays > 0;
//     const isAadhaarValid = /^[0-9]{12}$/.test(formData.aadhaarNumber);
//     const isLicenseNumberValid = formData.licenseNumber.trim().length > 0;
//     const isLicenseValidityDateValid = formData.licenseValidityDate.trim().length > 0;
...
//     if (!isNumberOfDaysValid) errors.numberOfDays = "Number of days must be greater than zero.";
//     if (!isAadhaarValid) errors.aadhaarNumber = "Please enter a valid 12-digit Aadhaar number.";
//     if (!isLicenseNumberValid) errors.licenseNumber = "Driving license number is required.";
//     if (!isLicenseValidityDateValid) errors.licenseValidityDate = "License validity date is required.";
...
//           {/* <div style={styles.formGroup}>
//             <label htmlFor="licenseNumber" style={styles.label}>Driving License Number</label>
//             <input
//               type="text"
//               id="licenseNumber"
//               name="licenseNumber"
...
//               style={styles.input}
//             />
//             {validationErrors.licenseNumber && <span style={styles.error}>{validationErrors.licenseNumber}</span>}
//           </div>

//           <div style={styles.formGroup}>
//             <label htmlFor="licenseValidityDate" style={styles.label}>License Validity Date</label>
//             <input
//               type="date"
...
//               style={styles.input}
//             />
//             {validationErrors.licenseValidityDate && <span style={styles.error}>{validationErrors.licenseValidityDate}</span>}
//           </div> */}
//           <div style={styles.formGroup}>
...
//     Please enter your Driving License Number in the format: <strong>XX00 12345678901</strong>
//   </p>
//   <input
//     type="text"
//     id="licenseNumber"
...
//     <span style={styles.error}>{validationErrors.licenseNumber}</span>
//   )}
// </div>
...
const Form1 = () => {
  ...
  useEffect(() => {
    ...
    const isNumberOfDaysValid = formData.numberOfDays > 0;
    const isAadhaarValid = /^[0-9]{12}$/.test(formData.aadhaarNumber);
    const isLicenseNumberValid = /^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$/.test(formData.licenseNumber); // Format example: AP12AB1234
    const isLicenseValidityDateValid = formData.licenseValidityDate.trim().length > 0;
    ...
    if (!isNumberOfDaysValid) errors.numberOfDays = "Number of days must be greater than zero.";
    if (!isAadhaarValid) errors.aadhaarNumber = "Please enter a valid 12-digit Aadhaar number.";
    if (!isLicenseNumberValid) errors.licenseNumber = "Please enter a valid Driving License number (e.g. AP12AB1234).";
    if (!isLicenseValidityDateValid) errors.licenseValidityDate = "License validity date is required.";
  ...
  const handleSubmit = (e) => {
    ...
    if (isFormValid) {
      axios
        .post('https://carwebsite-c2012-default-rtdb.firebaseio.com/register.json', formData)
        .then(() => {
          alert("Submitted successfully");
          setFormSubmitted(true); // If form is valid and submitted, show confirmation
        })
        .catch((error) => {
